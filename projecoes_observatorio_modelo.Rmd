...
```{r estimativa_crescimento_exponencial, fig.width =4.5,  fig.height = 3, fig.cap = paste("Estimativas de crescimento exponencial para os próximos 5 dias para  o", nome_titulos)}
################################################################################
