...
* No dia de hoje temos `r nconf$total.confirmed.cases[nrow(nconf)]` casos notificados.
...
```{r estimativa_crescimento_exponencial, fig.width = 7,  fig.height = 5, fig.cap = paste("Estimativas de crescimento exponencial para os próximos 5 dias para  o", nome_titulos)}
################################################################################
...
ggplot(data = ncasos.completa, aes(x = Index, y = casos, ymin = ic.low, ymax = ic.upp)) +
    ...
    scale_y_log10() +
    labs(y = "Número de casos", x = "Data", title = paste("Número de casos notificados em escala logarítimica - ", nome_titulos)) +
    plot.formatos
